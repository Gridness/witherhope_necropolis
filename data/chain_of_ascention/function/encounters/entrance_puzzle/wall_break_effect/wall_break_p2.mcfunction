playsound block.netherite_block.break ambient @a ~ ~ ~ 1.0 1.0
...
setblock 42 0 -65 chiseled_deepslate
setblock 42 0 -66 chiseled_deepslate
setblock 42 0 -67 chiseled_polished_blackstone
setblock 42 3 -64 air
setblock 42 3 -65 air
setblock 42 3 -66 air
setblock 42 3 -67 air

execute run schedule function chain_of_ascention:encounters/entrance_puzzle/wall_break_effect/wall_break_p3 2s