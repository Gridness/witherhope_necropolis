...
execute if entity @e[type=player,team=raider,tag=psionic_resistance] run schedule function chain_of_ascention:auras/psionic_resistance/psionic_resistance_remove 10s